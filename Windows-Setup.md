...
* If you want to install development tools on the local PC - .NET (use `https://github.com/dotnet/install-scripts/blob/main/src/dotnet-install.ps1` and add a PATH variable to `%USERPROFILE%\AppData\Local\Microsoft\dotnet`), NVM (use `https://github.com/coreybutler/nvm-windows`)
